  ...
  head: () => ({
    meta: [
      { title: "Cancellation Policy — Schema Weaver" },
      {
        name: "description",
        content:
          "Schema Weaver cancellation policy — details on how to cancel your subscription and what happens to your data and team access.",
      },
      { property: "og:title", content: "Cancellation Policy — Schema Weaver" },
      {
        property: "og:description",
        content:
          "Our official cancellation policy for Schema Weaver accounts and subscriptions.",
      },
      {
        property: "og:url",
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 sm:py-32">
        <div className="max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-10 text-muted-foreground leading-relaxed">
            <p>
              We understand that your project needs may change. This policy
              explains how to cancel your Schema Weaver subscription and the
              effect of that cancellation on your projects.
            </p>
            ...
            <section className="space-y-4 border-t border-border pt-10">
              ...
              <p>
                ...
                <strong>end of your current billing cycle</strong>. You will
                retain full access to all Pro or Team features until the end of
                the paid period. No partial refunds are provided for mid-cycle
                cancellations.
              </p>
            </section>
            ...
            <section className="space-y-4 border-t border-border pt-10">
              ...
              <ul className="list-disc pl-5 space-y-3">
                <li>
                  Your account will revert to the Free tier at the end of the
                  billing period.
                </li>
                <li>
                  Advanced features like Dijkstra path analysis and Resona AI
                  depth-edits may be limited.
                </li>
                <li>
                  Team shared projects will become read-only or private
