    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-5 gap-10">
        ...
        <div className="lg:col-span-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-semibold text-lg text-gradient-mesh">
              Schema Weaver
            </span>
          </div>
          <p className="mt-4 text-sm text-muted-foreground leading-relaxed max-w-xs">
            The Agentic Operating System for PostgreSQL. Infrastructure for the
            next generation of technical teams.
          </p>
          ...
          <div className="mt-6 flex items-center gap-3">
            <a
              href="https://twitter.com/Lnxtanx"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/company/schema-weaver"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="w-9 h-9 rounded-lg border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors"
            ...
            <a
              href="https://www.reddit.com/r/schemaweaver/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Reddit"
              className="w-9 h-9 rounded-lg border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors"
      ...
      <div className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <div>
            © {new Date().getFullYear()} VivekMind, Inc. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
