      ...
      title={
        <>
          ...
          <span className="text-gradient-mesh">
            The Spatial AI Database Architect.
          </span>
        </>
      }
      ...
      <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-2xl border border-border bg-card overflow-hidden flex flex-col">
          ...
          <div className="p-6 flex-1">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Anchor Resona to a specific table. It receives the full column,
              index, and relationship context for that node alone for
              hyper-focused analysis and DDL generation.
            </p>
          </div>
        </div>
          ...
          <div className="p-6 flex-1">
            <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-secondary font-bold">
              <img
                src="/resona.png"
                alt=""
                className="w-3.5 h-3.5 object-contain border border-secondary/20 rounded-sm bg-secondary/5"
              />
              Group AI
            </div>
            <h3 className="mt-3 font-display text-xl font-semibold">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Deploy Resona to a Schema Group. It reasons across entire
              namespaces (like `billing` or `auth`) to ensure consistency and
        ...
        <div className="rounded-2xl border border-border bg-card overflow-hidden flex flex-col">
          ...
          <div className="p-6 flex-1">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              The master architect. Global AI understands every file, every
              relationship, and every compiler layer in your project. Perfect
              for major refactors and new service scaffolding.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-12 grid md:grid-cols-2 gap-8">
        <div className="rounded-2xl border border-border bg-card/50 p-8">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Resona doesn't just output code. It uses{" "}
            <code className="text-foreground">workspace_patch_file</code> to
            find exact lines in your modular files and surgically updates them —
            preserving your comments, formatting, and file structure.
          </p>
        </div>
        <div className="rounded-2xl border border-border bg-card/50 p-8">
          <h4 className="font-display font-semibold text-lg flex items-center gap-2">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Watch the AI work in real-time. Resona plans its steps, executes its
            55 purpose-built tools, observes the compiler feedback, and
            self-heals until the schema is production-ready.
          </p>
        </div>
      </div>
      ...
      <div className="mt-10 rounded-2xl border border-primary/20 bg-primary/5 p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
        ...
        <div className="flex-1">
          ...
          <p className="mt-1 text-muted-foreground leading-relaxed">
            ...
            . Resona reasons over schema metadata and your questions — never
            over the rows themselves. Schema-first analysis means maximum
            privacy and zero exfiltration risk.
          </p>
        </div>
